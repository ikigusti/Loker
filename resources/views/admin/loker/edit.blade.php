                        ...
                        <form action="{{ route('loker.update', $loker->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control  @error('nama_team') is-invalid @enderror"
                                    name="nama_team" value="{{ $loker->nama_team }}">
                                @error('nama_team')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control  @error('rank') is-invalid @enderror"
                                    name="rank" value="{{ $loker->rank }}">
                                @error('rank')
                                    <span class="invalid-feedback" rank="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                @enderror
                            </div><div class="mb-3">
                                ...
                                <input type="text" class="form-control  @error('umur') is-invalid @enderror"
                                    name="umur" value="{{ $loker->umur }}">
                                @error('umur')
                                    <span class="invalid-feedback" umur="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                @enderror
                            </div>
