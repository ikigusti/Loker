                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="nama_team" value="{{ $loker->nama_team }}" readonly>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="rank" value="{{ $loker->rank }}" readonly>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Umur</label>
                            <input type="text" class="form-control" name="umur" value="{{ $loker->umur }}" readonly>
                        </div>
                        <div class="mb-3">
