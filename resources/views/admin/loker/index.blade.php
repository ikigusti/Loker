    ...
    @section('content')
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">Data Loker
                        <a href="{{ route('loker.create') }}" class="btn btn-sm btn-outline-primary" style="float: right">
                            Tambah Data
                        </a>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($loker as $data)
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('loker.destroy', $data->id) }}" method="post">
                                                    @csrf
                                                    @method('delete')
                                                    <a href="{{ route('loker.edit', $data->id) }}"
  ...
  <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
                                                    ...
                                                    <a href="{{ route('loker.show', $data->id) }}"
